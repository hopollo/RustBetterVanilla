...
public class ShopFront : StorageContainer
{
  ...
  [NonSerialized]
  public bool swappingItems;

  [NonSerialized]
  public static readonly Translate.Phrase TradeLockedError = new Translate.Phrase("error.tradelocked", "Trade Locked!");

  [NonSerialized]
  public static readonly Translate.Phrase TradeUnsuccessfulError = new Translate.Phrase("error.tradeunsuccessful", "Trade Unsuccessful!");

  public float AngleDotProduct => 1f - maxUseAngle / 90f;
  ...
  public bool CanAcceptVendorItem(Item item, int targetSlot)
  {
  ...
  public bool CanAcceptCustomerItem(Item item, int targetSlot)
  {
